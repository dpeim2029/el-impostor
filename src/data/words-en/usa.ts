...
export const usa: Categoria = {
  ...
  grupos: [
    ...
    { pista: 'Day off', palabras: ['Fourth of July', 'Memorial Day', 'Labor Day'] },
    { pista: 'Stadium', palabras: ['Super Bowl', 'Touchdown', 'Cheerleader', 'Home run'] },
    { pista: 'Classroom', palabras: ['Field trip', 'Spelling bee', 'Show and tell'] },
    { pista: 'Diner', palabras: ['Mac and cheese', 'Milkshake', 'Meatloaf', 'Corn dog'] },
    { pista: 'New York', palabras: ['Times Square', 'Central Park', 'Yellow cab', 'Broadway'] },
    { pista: 'Autograph', palabras: ['Walk of Fame', 'Oscars'] },
    {
      pista: 'Road trip',
      palabras: ['Grand Canyon', 'Route 66', 'Golden Gate Bridge', 'Yellowstone'],
    },
    { pista: 'Piggy bank', palabras: ['Quarter', 'Penny', 'Dime'] },
    { pista: 'Mall', palabras: ['Food court', 'Arcade'] },
    { pista: 'Limo', palabras: ['Prom', 'Sweet sixteen'] },
  ],
}
