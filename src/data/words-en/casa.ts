...
export const home: Categoria = {
  ...
  grupos: [
    ...
    { pista: 'Guests', palabras: ['Sofa', 'Cushion', 'Rug', 'Curtain'] },
    {
      pista: 'Restaurant',
      palabras: ['Plate', 'Glass', 'Spoon', 'Fork', 'Napkin', 'Table', 'Chair'],
    },
    { pista: 'Cinderella', palabras: ['Broom', 'Bucket', 'Mop'] },
    { pista: 'Homework', palabras: ['Desk', 'Computer', 'Bookshelf'] },
    { pista: 'Knock knock', palabras: ['Door', 'Doorbell', 'Doormat'] },
    { pista: 'Burglar', palabras: ['Window', 'Key', 'Lock'] },
