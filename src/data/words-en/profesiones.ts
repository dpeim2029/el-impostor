...
export const jobs: Categoria = {
  ...
  grupos: [
    ...
    { pista: 'Applause', palabras: ['Singer', 'Actor', 'Dancer', 'Magician', 'Acrobat', 'Clown'] },
    ...
    { pista: 'Map', palabras: ['Taxi driver', 'Delivery driver'] },
    { pista: 'Wedding', palabras: ['Photographer', 'DJ', 'Florist', 'Hairdresser'] },
    { pista: 'TV studio', palabras: ['Reporter', 'Presenter', 'Camera operator'] },
    { pista: 'Laptop', palabras: ['Programmer', 'Designer', 'YouTuber'] },
