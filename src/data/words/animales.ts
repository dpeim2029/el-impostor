...
export const animales: Categoria = {
  ...
  grupos: [
    ...
    { pista: 'Tarzán', palabras: ['Mono', 'Serpiente', 'Tigre', 'Loro', 'Cocodrilo'] },
    { pista: 'Granja', palabras: ['Vaca', 'Caballo', 'Gallina', 'Cerdo', 'Oveja', 'Burro'] },
    { pista: 'Veterinario', palabras: ['Perro', 'Gato', 'Hámster', 'Conejo'] },
    { pista: 'Buzo', palabras: ['Tiburón', 'Delfín', 'Pulpo', 'Ballena', 'Tortuga'] },
    ...
    { pista: 'Iglú', palabras: ['Pingüino', 'Oso polar', 'Foca'] },
  ],
}
